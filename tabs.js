document.addEventListener("DOMContentLoaded", function() {
    // Objeto para almacenar los datos del personaje
    let character = {
        basicInfo: {
            name: "",
            race: "",
    ...
    function switchTab(tabId) {
        ...
        // Actualizar la visualización con los datos guardados
    ...
    // Función para guardar los datos de la pestaña actual
    ...
    // Función para actualizar la visualización de la pestaña
    ...
    function saveCharacter() {
        // Guardar los datos de la pestaña actual
        saveCurrentTabData();
    ...
    // Función para descargar el personaje como archivo JSON
    function downloadCharacterJSON() {
        const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(character, null, 2));
        const downloadAnchorNode = document.createElement('a');
        downloadAnchorNode.setAttribute("href", dataStr);
        downloadAnchorNode.setAttribute("download", `${character.basicInfo.name || "character"}.json`);
        document.body.appendChild(downloadAnchorNode);
        downloadAnchorNode.click();
        downloadAnchorNode.remove();
    }

    // Agregar event listeners para los sliders de estadísticas
